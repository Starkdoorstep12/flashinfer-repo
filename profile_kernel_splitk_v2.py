...
from solution.triton.kernel import kernel_splitk_v2
...
for _ in range(10):
    output, lse = kernel_splitk_v2(q_nope, q_pe, ckv_cache, kpe_cache, sparse_indices, sm_scale, SPLIT_K=SPLIT_K)
